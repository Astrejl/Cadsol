...
begin
  LabelDim.Visible:=Self.ItemProprietes.Checked;
  With CadranMultiple do
  LabelDim.Caption:='Largeur: '+IntToStr(Largeur div 10)+' x '+IntToStr(NbCadLargeur)+' = '+ IntToStr(LargeurTot div 10)+ '     '+
                    'Hauteur: '+IntToStr(Hauteur div 10)+' x '+IntToStr(NbCadHauteur)+' = '+ IntToStr(HauteurTot div 10)+ '  (mm)'
end;
